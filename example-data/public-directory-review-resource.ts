...
export const publicDirectoryReviewDecisionExample = {
  ...
  kind: "ReviewDecision",
  metadata: {
    name: "public-directory-availability-operator-decision",
  },
  spec: {
    reviewItemName: "public-directory-availability",
  ...
  status: {
    appliedToClaimIds: ["public-field.entity-123.availability-status.current"],
  },
