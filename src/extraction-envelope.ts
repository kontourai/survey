...
export function validateExtractionEnvelopeImport(value: unknown): ExtractionEnvelopeImport {
  validateImport(value);
  return cloneJson(value) as ExtractionEnvelopeImport;
}
...
function identityHash(v: unknown): string { return sha256Hex(canonicalJson(v)).slice(0, 20); }
